...
public
	...
	attr_reader :clock_now, :time_step, :clock_start
#	attr_reader :components, :settings
	
	attr_accessor :name, :zeno_limit, :clock_finish
	...
	def initialize(arg = {})
		...
		@zeno_limit		= settings[:zeno_limit]
		@clock_start	= settings[:clock_start]
		@clock_finish	= settings[:clock_finish]
